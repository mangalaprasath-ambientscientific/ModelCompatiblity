...
browser.Host = class {
    ...
    async view(view) {
        ...
        const consent = async () => {
            // EDGESPHERE PATCH: embedded viewer - no cookie-consent dialog, no ipinfo.io lookup.
            // Telemetry is inert anyway (it is gated on this._environment.packaged, which is false for a 0.0.0 build).
            return;
